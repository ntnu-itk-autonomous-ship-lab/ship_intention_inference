...
INTENTION_INFERENCE::IntentionModelParameters setModelParameters(int num_ships){
    ...
    param.situation_start_distance.sigma = 750;
    param.situation_start_distance.n_bins = 30;
    param.situation_start_distance.max = 9000;*/
    /*param.situation_start_distance.mu = 3000;
    param.situation_start_distance.sigma = 3000;
    param.situation_start_distance.n_bins = 30;
    param.situation_start_distance.max =5000;*/
    param.speed.max = 18;
