...
for i = 1:length(shipnames)
    ...
    if(has_added_legend)
        ...
        plot(xs(i,evaluation),ys(i,evaluation), 'X', 'LineWidth',6, 'Color', '#8800FF','HandleVisibility','off');
        plot(xs(i,step_nr),ys(i,step_nr), 'X', 'LineWidth',4, 'Color', '#FF00FF','HandleVisibility','off');
        %plot(xs(i,5),ys(i,5), 'X', 'LineWidth',4, 'Color', '#FF00FF','HandleVisibility','off');
    else
        plot(xs(i,1),ys(i,1), 'X', 'LineWidth',3, 'Color', '#77AC30', 'DisplayName', 'Startpoint');
        has_added_legend =true;
        plot(xs(i,evaluation),ys(i,evaluation), 'X', 'LineWidth',6, 'Color', '#8800FF', 'DisplayName', 'Point of evaluation');
